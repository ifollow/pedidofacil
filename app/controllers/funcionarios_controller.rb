class FuncionariosController < ApplicationController
  ...
  def index
    @funcionarios = Funcionario.where("estabelecimento_id =? ", session[:id_estabelecimento])
  end
  ...
  def create
    ...
    respond_to do |format|
      if @funcionario.save
        format.html { redirect_to funcionarios_url, notice: 'Funcionario criado com sucesso.' }
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:estabelecimento_id, :nome, :endereco, :cidade, :telefone, :celular, :cpf, :rg, :salario, :percentual, :codigo)
    end
end
