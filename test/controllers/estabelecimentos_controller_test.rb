...
class EstabelecimentosControllerTest < ActionController::TestCase
  ...
  test "should create estabelecimento" do
    assert_difference('Estabelecimento.count') do
      post :create, estabelecimento: { endereco: @estabelecimento.endereco, image_restaurante: @estabelecimento.image_restaurante, nome: @estabelecimento.nome, razao_social: @estabelecimento.razao_social, responsavel: @estabelecimento.responsavel, tel_responsavel: @estabelecimento.tel_responsavel, telefone: @estabelecimento.telefone }
    end
  ...
  test "should update estabelecimento" do
    patch :update, id: @estabelecimento, estabelecimento: { endereco: @estabelecimento.endereco, image_restaurante: @estabelecimento.image_restaurante, nome: @estabelecimento.nome, razao_social: @estabelecimento.razao_social, responsavel: @estabelecimento.responsavel, tel_responsavel: @estabelecimento.tel_responsavel, telefone: @estabelecimento.telefone }
    assert_redirected_to estabelecimento_path(assigns(:estabelecimento))
  end
