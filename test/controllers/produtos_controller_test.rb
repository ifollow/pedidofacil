...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { cardapio_id: @produto.cardapio_id, estabelecimento_id: @produto.estabelecimento_id, nome: @produto.nome, preco: @produto.preco }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { cardapio_id: @produto.cardapio_id, estabelecimento_id: @produto.estabelecimento_id, nome: @produto.nome, preco: @produto.preco }
    assert_redirected_to produto_path(assigns(:produto))
  end
